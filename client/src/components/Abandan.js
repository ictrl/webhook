...
export default function Abandan() {
  ...
  const handleCustomerCheck1 = useCallback(
    newChecked => setCheckedCustomer1(newChecked),
    []
  );
  const handleAdminCheck1 = useCallback(
    newChecked => setCheckedAdmin1(newChecked),
    []
  );
  //select enable
  ...
  const handleCustomerCheck2 = useCallback(
    newChecked => setCheckedCustomer2(newChecked),
    []
  );
  const handleAdminCheck2 = useCallback(
    newChecked => setCheckedAdmin2(newChecked),
    []
  );
  //select enable
  ...
  const handleCustomerCheck3 = useCallback(
    newChecked => setCheckedCustomer3(newChecked),
    []
  );
  const handleAdminCheck3 = useCallback(
    newChecked => setCheckedAdmin3(newChecked),
    []
  );
  //select enable
  ...
  const handleCustomerCheck4 = useCallback(
    newChecked => setCheckedCustomer4(newChecked),
    []
  );
  const handleAdminCheck4 = useCallback(
    newChecked => setCheckedAdmin4(newChecked),
    []
  );
  //select enable
