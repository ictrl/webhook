              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      {" "}
                      <input type="checkbox" name="orders/create admin" />{" "}
                      Notify Admin{" "}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      {" "}
                      <input type="checkbox" name="refunds/create admin" />{" "}
                      Notify Admin{" "}
                    </td>
                  </tr>
                </tbody>
        ...
        <section id="sender">
          <div className="row">
            ...
            <div className="col-md-7 admin2 mr-2 gray">
              ...
              <ul>
                <li>
                  Sender ID is the alpha-character name or number which appears
                  on the mobile phone as the sender of a SMS (It is used to
                  identify who’s sending the message to the recipient). Sender
                  ID can be a alphacharacter name such as the name of your
                  company.
                </li>
                <li>
                  You can enter sender id for approval, once approved all your
                  sms notifications will be sent with approved sender id for
                  you.
                </li>
